...
"#;
    ...
    #[test]
    fn call_site_tracks_qualified_name_in_class() {
        let src = r#"
class MyClass:
    def method(self):
        self.helper()
"#;
        ...
        assert_eq!(call.function_call.caller_qualified_name, "MyClass.method");
        assert!(call.function_call.is_self_call);
    }
...
"#;
    ...
    #[test]
    fn call_site_detects_direct_import_call() {
        let src = r#"
import requests
